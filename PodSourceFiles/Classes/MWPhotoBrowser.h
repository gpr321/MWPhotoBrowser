...
- (void)photoBrowser:(MWPhotoBrowser *)photoBrowser setMainImgAtIndex:(NSUInteger)index;
...
@property (nonatomic, weak) id<MWPhotoBrowserDataSource> dataSource;
